...
export const getAllSettings = ({page , size })=>{
    return useMainApi(`${route+routes.settings}?page=${page||1}&size=${size||10}`  )
}
...
export const getAllStaffs = ({page , size })=>{
    return useMainApi(`${route+routes.staffs}?page=${page||1}&size=${size||10}`  )
}
...
export const getAllCertificates = ({page , size })=>{
    return useMainApi(`${route+routes.certificates}?page=${page||1}&size=${size||10}`  )
}
...
export const getAllSurgery = ({page , size })=>{
    return useMainApi(`${route+routes.surgery}?page=${page||1}&size=${size||10}`  )
}
...
export const getAllEvents = ({page , size })=>{
    return useMainApi(`${route+routes.events}?page=${page||1}&size=${size||10}`  )
}
...
export const getAllApplication = ({page , size })=>{
    return useMainApi(`${route+routes.application}?page=${page||1}&size=${size||10}`  )
}
